                      ...
                      <div className={styles.projectDetails}>
                        ...
                        <ul>
                          ...
                          <li>
                            ...
                            time to time things happenes like elections and
                    ...
                    {(close) => (
                      <div className={styles.projectDetails}>
                        ...
                        <ul>
                          ...
                          <li>
                            It was very usefull project as doctors and patients
                            it was the digital bridge between parients and
                            doctors
                          </li>
                          <li>
                      ...
                      <div className={styles.projectDetails}>
                        ...
                        <ul>
                          <li>
                            ...
                            Infotech Pvt. Ltd.) that time i was working on this
                            organisation
                          </li>
                          <li>I started work RWD from this time</li>
                        </ul>
                        <p>
                          <strong>Technology:</strong> HTML5, CSS3, RWD, jQuery
                          etc.
                        </p>
                        <p>
                          <strong>Tools:</strong> Dreamviewer, Photoshop,
