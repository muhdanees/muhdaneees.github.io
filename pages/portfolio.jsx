      ...
      <div className="content">
        <div className="container flex-cont">
          ...
          <div className="sec-divs">
            <h2>Portfolio</h2>
            <p>
              A front-end developer with having good ability for solving Quickly
              things along with 10+ years of great industry experience.
            </p>
            <p>
              I have worked diffirent type of companies Advertise Company, Media
              House, digital news, software developement and subscription
              developemt. every company has diffirent mind set because of
              different critaria but have learned according to the companies.
            </p>
                        ...
                        <div className={styles.projectDetails}>
                          ...
                          <ul>
                            ...
                            <li>
                              ...
                              Quickly respond to{" "}
                              <strong>critical support</strong>
                            ...
                            <li>
                              <strong>Assist</strong> Other Sr. Engineers with
                              other tasks as allined.
                            </li>
                            <li>
                            ...
                            <li>
                              As you know its a <strong>media company</strong>{" "}
                              so time to time things happenes like elections and
                              third party <strong>ads</strong> as well on our
                              website alos lots of <strong>widgets</strong> and
                              AMP <strong>Story</strong> pages too.
                            </li>
                          </ul>
                          <p>
                            <strong>Technology:</strong> HTML5, CSS3, Flexbox,
                            SASS, RWD, Grid Systems, JavaScript, jQuery etc.
                          </p>
                          <p>
                    ...
                    >
                      {(close) => (
                        <div className={styles.projectDetails}>
                          ...
                          <ul>
                            <li>
                              worked on this project as few months on election
                              time
                            </li>
                            <li>
                          ...
                          <p>
                            <strong>Technology:</strong> HTML5, CSS3, Flexbox,
                            RWD, Grid Systems, JavaScript, jQuery etc.
                          </p>
                          <p>
                            <strong>Tools:</strong> VS Code, Zeplin, Jira, GIT,
                            HighCharts for charts making
                          </p>
                        </div>
                      )}
                    </Popup>
                      ...
                      {(close) => (
                        <div className={styles.projectDetails}>
                          ...
                          <ul>
                            ...
                            <li>
                              Converted PSD to HTML5 along with CSS3 alos worked
                              on Mobile as seperate Mobile application
                            </li>
                            <li>
                              wrote code from scratch and romved jQueery mobile
                    ...
                    >
                      {(close) => (
                        <div className={styles.projectDetails}>
                          ...
                          <ul>
                            <li>
                              Fully, I made this design and developement along
                              with logo as you are watching
                            </li>
                            <li>
                              Bootstrap 4, for Responsive deisgn developement
                              and Adobe XD for Template deisgn
                            </li>
                          </ul>
                          <p>
                            <strong>Technology:</strong> HTML5, CSS3, Flexbox,
                            RWD, Grid Systems, jQuery etc.
                          </p>
                          <p>
                    ...
                    >
                      {(close) => (
                        <div className={styles.projectDetails}>
                          ...
                          <ul>
                            <li>
                              I designed and developement this project as
                              requried things from documents and delivered
                              smoothly
                            </li>
                    ...
                    >
                      {(close) => (
                        <div className={styles.projectDetails}>
                          ...
                          <ul>
                            <li>
                              I worked for this company, fully all things like
                              logo, visiting cards, envelope, letterhead, and
                              hoarding design too.
                            </li>
                          </ul>
                          <p>
                            <strong>Technology:</strong> Grid Systems for Better
                            prototype
                          </p>
                          <p>
                      ...
                      {(close) => (
                        <div className={styles.projectDetails}>
                          ...
                          <ul>
                            ...
                            <li>
                              It was very usefull project as doctors and
                              patients it was the digital bridge between
                              parients and doctors
                            </li>
                            <li>
                              Custome Design Pdf generator with backend
                              developers in Jquery and JavaScript. was working
                              smoothly
                            </li>
                          </ul>
                          <p>
                            <strong>Technology:</strong> HTML5, CSS3, RWD, Grid
                            Systems, jQuery etc.
                          </p>
                          <p>
                    ...
                    >
                      {(close) => (
                        <div className={styles.projectDetails}>
                          ...
                          <ul>
                            <li>
                              It was running project when i joned still was
                              running perfectly
                            </li>
                            <li>worked with .Net developers in this project</li>
                          </ul>
                          <p>
                            <strong>Technology:</strong> HTML5, CSS3, jQuery
                            etc.
                          </p>
                          <p>
                            <strong>Tools:</strong> Sublime Text 3, Dreamviewer,
                      ...
                      {(close) => (
                        <div className={styles.projectDetails}>
                          ...
                          <ul>
                            ...
                            <li>
                              I didn&apos;t now about LifeRay before worked on it.
                            </li>
                          </ul>
                          <p>
                            <strong>Technology:</strong> HTML5, CSS3, jQuery
                      ...
                      {(close) => (
                        <div className={styles.projectDetails}>
                          ...
                          <ul>
                            ...
                            <li>
                              can check the menu of this project its was superb
                              for me
                            </li>
                          </ul>
                          <p>
                      ...
                      {(close) => (
                        <div className={styles.projectDetails}>
                          ...
                          <ul>
                            ...
                            <li>
                              I designed and implement lots of thing on this
                              project full covered menu with superb designed
                            </li>
                          </ul>
                          <p>
                            <strong>Technology:</strong> HTML5, CSS3, jQuery
                    ...
                    >
                      {(close) => (
                        <div className={styles.projectDetails}>
                          ...
                          <ul>
                            <li>
                              I designed and developed this website for SEO
                              purpose whitch was for Organisation (Oscillate
                              Infotech Pvt. Ltd.) that time i was working on
                              this organisation
                            </li>
                            <li>I started work RWD from this time</li>
                          </ul>
                          <p>
                            <strong>Technology:</strong> HTML5, CSS3, RWD,
                            jQuery etc.
                          </p>
                          <p>
                            <strong>Tools:</strong> Dreamviewer, Photoshop,
                    ...
                    >
                      {(close) => (
                        <div className={styles.projectDetails}>
                          ...
                          <ul>
                            <li>
                              I designed and developed this website for out
                              client along with header animation in flash that
                              was superb that time, not still running...
                            </li>
                            <li>
                              check this design in the section of Portfolio
                              <a href="http://makbog.com/">http://makbog.com</a>
                              . I was working in this organisation that time
                              (Makbod Solutions Pvt ltd.)
                            </li>
                            <li>
                              I started work in DIVs becuase that time
                              developers was working in Table structure
                            </li>
                            <li>
                              I worked as <strong>wordpress developer</strong>{" "}
                              in this organisation
                            </li>
                          </ul>
                          <p>
                            <strong>Technology:</strong> HTML5, CSS3, Wordpress,
                            jQuery etc.
                          </p>
                          <p>
                            <strong>Tools:</strong> Dreamviewer, Photoshop,
                        ...
                        <div className={styles.projectDetails}>
                          ...
                          <ul>
                            <li>
                              ...
                              designed this logo for this organisation before
                              joined this company
                            </li>
                            <li>
                              I useed to work on wordpress as well in this
                              organisation.
                            </li>
                            <li>
                              I have completed lots of project becuase its a
                              service based company
                            </li>
                          </ul>
                          <p>
                            <strong>Technology:</strong> HTML5, CSS3, Flexbox,
                            SASS, JavaScript, jQuery etc.
                          </p>
                          <p>
                            <strong>Tools:</strong> Dreamviewer, Photoshop,
                            Notepad++
                    ...
                    >
                      {(close) => (
                        <div className={styles.projectDetails}>
                          ...
                          <ul>
                            <li>
                              I designed and developed HTMl and CSS along with
                              Flash animations for Banner fo the website. Also i
                              worked on this website in Pure DIVs as you can see
                              the code in view pages source code.
                            </li>
                            <li>
                          ...
                          <p>
                            <strong>Technology:</strong> HTML5, CSS3, Flash
                            Animations, jQuery etc.
                          </p>
                          <p>
                            <strong>Tools:</strong> Dreamviewer, Photoshop,
                            Flash, Notepad++
